...
function Herosection() {
    return (
        ...
        <div className="pl-24 pt-24 container">
            ...
            <button className=" text-white bg-gray-800 scale-125 border-spacing-36 border-white rounded-lg hover:bg-white border-2 hover:text-black hover:scale-150 transition-all">Contate-me</button>
        </div>
        <div>
